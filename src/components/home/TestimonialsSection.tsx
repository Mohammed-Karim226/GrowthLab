          ...
          {testimonials.map((item, index) => (
            ...
            >
              ...
              <div className="mb-6 flex items-center gap-4">
                ...
                <div>
                  <p className="font-semibold text-xl text-white tracking-tight">{item.name}</p>
              ...
              >
                ...
                <p className="text-xs uppercase tracking-[2px] text-emerald-400 font-mono mt-1">AFTER 90 DAYS</p>
              </motion.div>
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center gap-3 text-sm">
                  ...
                  <div>
                    <p className="text-emerald-400 text-xs font-mono">AUDIENCE</p>
                    <p className="text-white">{item.before} → {item.after}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute bottom-6 right-6 flex items-center gap-1.5 bg-black/60 backdrop-blur-md px-3 py-1 rounded-2xl border border-emerald-500/30 text-[10px] font-mono text-emerald-400 z-20">
