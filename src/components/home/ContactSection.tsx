              ...
              {[
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 mt-1.5">{item.desc}</p>
                  </div>
                </motion.div>
              ))}
            </div>
            ...
            <div className="relative rounded-3xl border border-white/10 bg-[#0A0E27] p-10 lg:p-12 shadow-2xl backdrop-blur-3xl">
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    <FieldLabel className="text-xs font-mono tracking-widest text-cyan-400 mb-2">FIRST NAME</FieldLabel>
                    <Controller
                      name="firstName"
                      ...
                      render={({ field, fieldState }) => (
                        <Field data-invalid={fieldState.invalid}>
                          <Input
                            {...field}
                            placeholder="Alex"
                            className="h-14 bg-white/5 border border-white/10 focus:border-cyan-400 rounded-lg text-base placeholder:text-slate-500 placeholder:pl-4 focus:ring-2 focus:ring-cyan-400/30 transition-all"
                          />
                  ...
                  <div>
                    <FieldLabel className="text-xs font-mono tracking-widest text-cyan-400 mb-2">LAST NAME</FieldLabel>
                    <Controller
                      name="lastName"
                      control={form.control}
                      render={({ field, fieldState }) => (
                ...
                <div>
                  <FieldLabel className="text-xs font-mono tracking-widest text-cyan-400 mb-2">EMAIL ADDRESS</FieldLabel>
                  <Controller
                    name="email"
                    control={form.control}
                    render={({ field, fieldState }) => (
                ...
                <div>
                  <FieldLabel className="text-xs font-mono tracking-widest text-cyan-400 mb-2">PHONE NUMBER</FieldLabel>
                  <Controller
                    name="phone"
                    control={form.control}
                    render={({ field, fieldState }) => (
                  ...
                  <div className="relative flex items-center justify-center gap-3 text-black font-bold max-sm:text-base">
                    {isSubmitting ? (
                      ...
                      <>
                        ...
                        <ArrowRight className="group-hover:translate-x-2 transition-transform max-sm:size-6" />
                      </>
                    )}
                  </div>
                </motion.button>
